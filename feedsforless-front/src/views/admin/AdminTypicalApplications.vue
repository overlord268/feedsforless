<template>
  <div class="space-y-5">
    ...
    <CrudTable :columns="columns" :items="items" :loading="loading" title="Typical applications" search-placeholder="Search applications…" item-label="applications">
      <template #row="{ item }">
    ...
    >
      ...
      />
      <div>
        <label for="typical-app-description" class="block text-sm font-medium text-slate-700 mb-1.5">Description</label>
        <textarea
          id="typical-app-description"
...
const modalTitle = computed(() =>
  editingId.value ? 'Edit typical application' : 'Add typical application'
);
