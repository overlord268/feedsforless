        ...
        <table class="w-full text-sm min-w-[600px]">
          <thead class="bg-slate-50/80 border-b border-slate-200">
            <tr class="text-left">
              ...
              <th class="px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">Type</th>
      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 border border-slate-200/80">
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
          <div>
            ...
            <input v-model="form.label" type="text" required class="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all" placeholder="e.g. pH" />
          </div>
          <div>
            <label class="block text-sm font-medium text-slate-700 mb-1.5">Type</label>
            <input v-model="form.type" type="text" class="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all" placeholder="Optional" />
          </div>
