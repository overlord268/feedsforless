        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-card flex flex-col">
          ...
          <div v-else class="space-y-3 overflow-y-auto flex-1 min-h-0">
            <div v-for="(quote, i) in clientStats.recent_quotes" :key="quote.id" class="flex gap-3 pb-3 border-b border-slate-100 dark:border-slate-700 last:border-0 last:pb-0">
              <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0" :class="quote.status === 'pending' ? 'bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-400' : quote.status === 'quoted' ? 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-400' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300'">
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card hover:shadow-card-hover transition-shadow relative overflow-hidden group">
          <div class="absolute right-0 top-0 -mt-4 -mr-4 w-28 h-28 bg-amber-50 dark:bg-amber-900/20 rounded-3xl opacity-60 group-hover:scale-110 transition-transform duration-300"></div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card hover:shadow-card-hover transition-shadow relative overflow-hidden group">
          <div class="absolute right-0 top-0 -mt-4 -mr-4 w-28 h-28 bg-emerald-50 dark:bg-emerald-900/20 rounded-3xl opacity-60 group-hover:scale-110 transition-transform duration-300"></div>
          <div class="flex items-center justify-between relative z-10">
            <div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card hover:shadow-card-hover transition-shadow relative overflow-hidden group">
          <div class="absolute right-0 top-0 -mt-4 -mr-4 w-28 h-28 bg-slate-100 dark:bg-slate-700 rounded-3xl opacity-60 group-hover:scale-110 transition-transform duration-300"></div>
          <div class="flex items-center justify-between relative z-10">
            <div>
        ...
        <div class="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card overflow-hidden flex flex-col">
          ...
          <div v-else class="space-y-4 overflow-y-auto flex-1 min-h-0">
            <div v-for="(quote, i) in adminStats.recent_quotes" :key="quote.id" class="flex relative">
              ...
              <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 z-10 ring-4 ring-white dark:ring-slate-800" :class="quote.status === 'pending' ? 'bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-400' : 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-400'">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
              </div>
              <div class="ml-4 pb-5">
